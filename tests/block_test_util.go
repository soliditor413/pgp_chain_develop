...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, &core.CacheConfig{TrieCleanLimit: 0}, config, engine, engine, vm.Config{}, nil)
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/*
See https://github.com/elastos/tests/wiki/Blockchain-Tests-II
