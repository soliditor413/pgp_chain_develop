...
// This file is part of pgp-chain.
//
// pgp-chain is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// pgp-chain is distributed in the hope that it will be useful,
...
// Package utils contains internal helper functions for pgp-chain commands.
package utils
...
import (
	...
	"github.com/pgprotocol/pgp-chain/dashboard"
	"github.com/pgprotocol/pgp-chain/eth"
	"github.com/pgprotocol/pgp-chain/eth/downloader"
	"github.com/pgprotocol/pgp-chain/eth/gasprice"
	"github.com/pgprotocol/pgp-chain/ethdb"
	"github.com/pgprotocol/pgp-chain/ethstats"
	"github.com/pgprotocol/pgp-chain/graphql"
	"github.com/pgprotocol/pgp-chain/les"
	"github.com/pgprotocol/pgp-chain/log"
	"github.com/pgprotocol/pgp-chain/metrics"
	"github.com/pgprotocol/pgp-chain/metrics/influxdb"
	"github.com/pgprotocol/pgp-chain/miner"
	"github.com/pgprotocol/pgp-chain/node"
	"github.com/pgprotocol/pgp-chain/p2p"
	"github.com/pgprotocol/pgp-chain/p2p/discv5"
	"github.com/pgprotocol/pgp-chain/p2p/enode"
	"github.com/pgprotocol/pgp-chain/p2p/nat"
	"github.com/pgprotocol/pgp-chain/p2p/netutil"
	"github.com/pgprotocol/pgp-chain/params"
	"github.com/pgprotocol/pgp-chain/rpc"
	whisper "github.com/pgprotocol/pgp-chain/whisper/whisperv6"
...
var (
	...
	ListenPortFlag = cli.IntFlag{
		...
		Value: node.DefaultListenP2pPort,
	}
...
func MakeDeveloperFeeContractAddress(ctx *cli.Context) ([]string, error) {
	if !ctx.GlobalIsSet(DeveloperFeeContract.Name) {
		ctx.GlobalSet(DeveloperFeeContract.Name, "0x4909fcaf28f539a0307a306d2788174aa733d911") ////PG
	}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	default: //main net
		//ctx.GlobalSet(FrozenAccount.Name, "0x0000000000000000000000000000000000000000")
		//ctx.GlobalSet(FrozenAccount.Name, "0x0000000000000000000000000000000000000000")
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb ethdb.Database) {
	...
	chain, err = core.NewBlockChain(chainDb, cache, config, engine, engine, vmcfg, nil)
	if err != nil {
