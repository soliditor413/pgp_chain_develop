...
import (
	...
	chainbridge_core "github.com/pgprotocol/pgp-chain/chainbridge-core"
	...
	"github.com/pgprotocol/pgp-chain/internal/debug"
	...
	_ "github.com/pgprotocol/pgp-chain/eth/tracers/js"
	_ "github.com/pgprotocol/pgp-chain/eth/tracers/native"
...
var (
	...
	app = utils.NewApp(gitCommit, gitDate, "the pgp-chain command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2019 The pgp-chain Authors"
