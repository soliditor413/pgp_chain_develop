...
import (
	...
	"github.com/pgprotocol/pgp-chain/accounts/scwallet"
	...
	"github.com/pgprotocol/pgp-chain/eth/tracers/logger"
...
//
// https://github.com/pgprotocol/pgp-chain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/pgprotocol/pgp-chain/wiki/Management-APIs#personal_ecRecover
...
// Unpair deletes a pairing between wallet and pgp.
...
func DoCall(ctx context.Context, b Backend, args CallArgs, blockNrOrHash rpc.BlockNumberOrHash, overrides map[common.Address]account, vmCfg vm.Config, timeout time.Duration, globalGasCap *big.Int) (*core.ExecutionResult, error) {
	...
	msg := types.NewMessage(addr, args.To, 0, value, gas, gasPrice, data, false, accessList)
...
func DoEstimateGas(ctx context.Context, b Backend, args CallArgs, blockNrOrHash rpc.BlockNumberOrHash, gasCap *big.Int) (hexutil.Uint64, error) {
	...
	if args.Gas != nil && uint64(*args.Gas) >= params.TxGas {
		...
		if block == nil || block.Header() == nil {
			return 0, errors.New("error block")
		}
		hi = block.GasLimit()
	}
	...
	for index, trace := range logs {
		...
		if trace.Stack != nil {
			...
			for i, stackValue := range trace.Stack {
				v := big.NewInt(0).SetBytes(stackValue.Bytes())
				stack[i] = fmt.Sprintf("%x", math.PaddedBigBytes(v, 32))
			}
