...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "pgp.ipc", false, filepath.Join(os.TempDir(), "pgp.ipc")},
		{"data", "pgp.ipc", false, "data/pgp.ipc"},
		{"data", "./pgp.ipc", false, "./pgp.ipc"},
		{"data", "/pgp.ipc", false, "/pgp.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "pgp.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "pgp.ipc", true, `\\.\pipe\geth.ipc`},
