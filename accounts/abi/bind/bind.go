...
//
// Detailed usage document and tutorial available on the pgp-chain Wiki page:
// https://github.com/pgprotocol/pgp-chain/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
