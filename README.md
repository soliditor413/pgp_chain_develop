...
HTTP based JSON-RPC API options:
  ...
  * `--wsport` WS-RPC server listening port (default: 20655)
...
Please see the [Developers' Guide](https://github.com/pgprotocol/pgp-chain/wiki/Developers'-Guide)
for more details on configuring your environment, managing project dependencies, and
testing procedures.

## License

The pgp-chain library (i.e. all code outside of the `cmd` directory) is licensed under the
[GNU Lesser General Public License v3.0](https://www.gnu.org/licenses/lgpl-3.0.en.html),
also included in our repository in the `COPYING.LESSER` file.

The pgp-chain binaries (i.e. all code inside of the `cmd` directory) is licensed under the
