...
func TestForkIDSplit(t *testing.T) {
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, nil, configNoFork, engine, engine, vm.Config{}, nil)
		chainProFork, _ = core.NewBlockChain(dbProFork, nil, configProFork, engine, engine, vm.Config{}, nil)
