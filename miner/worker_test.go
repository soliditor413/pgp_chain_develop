...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db ethdb.Database, n int) *testWorkerBackend {
	...
	chain, _ := core.NewBlockChain(db, &core.CacheConfig{TrieDirtyDisabled: true}, gspec.Config, engine, engine, vm.Config{}, nil)
...
func testGenerateBlockAndImport(t *testing.T, isClique bool) {
	...
	chain, _ := core.NewBlockChain(db2, nil, b.chain.Config(), engine, engine, vm.Config{}, nil)
	defer chain.Stop()
