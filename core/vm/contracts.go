...
import (
	...
	"github.com/pgprotocol/pgp-chain/crypto/blake2b"
	"github.com/pgprotocol/pgp-chain/crypto/bls12381"
	"github.com/pgprotocol/pgp-chain/crypto/bn256"
...
var PrecompiledContractsByzantium = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress(params.IsProducerAddress.Bytes()):    &isProducer{},
...
type isProducer struct{}

func (c *isProducer) RequiredGas(input []byte) uint64 {
	return 0
}
