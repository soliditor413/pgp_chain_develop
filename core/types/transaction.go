...
func NewMessage(from common.Address, to *common.Address, nonce uint64, amount *big.Int, gasLimit uint64, gasPrice *big.Int, data []byte, checkNonce bool, accessList AccessList) Message {
	return Message{
		from:       from,
		to:         to,
		nonce:      nonce,
